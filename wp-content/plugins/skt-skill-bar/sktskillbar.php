...
function skillwrapper_func( $atts, $content = null ) {
	...
	switch ( $type ){
        ...
        case 'gage1':
			...
			foreach($numAr as $n => $b){ 
				$n++; 
				$cssVar .= (count($numAr) == $n) ? '#g1g'.$n : '#g1g'.$n.', ';  
			}
			$wrapCode .= $cssVar.'{ width:200px; height:160px; display: inline-block; margin: 1em; }
				#gage1_chart{text-align:'.$align.';}';
			$wrapCode .= '</style>';
			$wrapCode .= '<script>';
			$sbIds = '';
			foreach($numAr as $n => $b){ 
				$n++; 
				$sbIds .= (count($numAr) == $n) ? 'g1g'.$n : 'g1g'.$n.', ';  
			}
			$wrapCode .= 'var '.$sbIds.';'."\n";
			$wrapCode .= 'function anup1(){';
				foreach($numAr as $n => $v){ 
					$n++; 
					$wrapCode .= 'var g1g'.$n.' = new JustGage({
						  id: "g1g'.$n.'", 
						  value: '.$v[0].',
						  title: "'.$v[1].'",
						  valueFontColor: "'.$v[2].'",
			...
			$wrapCode .= 'jQuery(document).ready( function(){
				if ( jQuery("#gage1_chart").next().is(":appeared") ){
					if (  ! jQuery("#gage1_chart").hasClass("gc_active") ) {
						anup1();
						jQuery("#gage1_chart").addClass("gc_active");
					}
				} else {
					jQuery( window ).scroll(function() {
						if ( jQuery("#gage1_chart").next().is(":appeared") ){
			...
			$wrapCode .= '<div id="gage1_chart">';
			foreach($numAr as $n => $b){ 
				$n++;
				$wrapCode .= '<div id="g1g'.$n.'"></div>';
			} 
			$wrapCode .= '</div>';
			$wrapCode .= '<div style="clear:both; height:10px; overflow:hidden;"></div>';
			break;
        case 'gage2':
			...
			foreach($numAr as $n => $b){ 
				$n++; 
				$cssVar .= (count($numAr) == $n) ? '#g2g'.$n : '#g2g'.$n.', ';  
			}
			$wrapCode .= $cssVar.'{ width:200px; height:160px; display: inline-block; margin: 1em; }
				#gage2_chart{text-align:'.$align.';}';
			$wrapCode .= '</style>';
			$wrapCode .= '<script>';
			$sbIds = '';
			foreach($numAr as $n => $b){ 
				$n++; 
				$sbIds .= (count($numAr) == $n) ? 'g2g'.$n : 'g2g'.$n.', ';  
			}
			$wrapCode .= 'var '.$sbIds.';'."\n";
			$wrapCode .= 'function anup2(){';
				foreach($numAr as $n => $v){ 
					$n++; 
					$wrapCode .= 'var g2g'.$n.' = new JustGage({
						  id: "g2g'.$n.'", 
						  value: '.$v[0].',
						  title: "'.$v[1].'",
						  valueFontColor: "'.$v[2].'",
			...
			$wrapCode .= 'jQuery(document).ready( function(){
				if ( jQuery("#gage2_chart").next().is(":appeared") ){
					if (  ! jQuery("#gage2_chart").hasClass("gc_active") ) {
						anup2();
						jQuery("#gage2_chart").addClass("gc_active");
					}
				} else {
					jQuery( window ).scroll(function() {
						if ( jQuery("#gage2_chart").next().is(":appeared") ){
			...
			$wrapCode .= '<div id="gage2_chart">';
			foreach($numAr as $n => $b){ 
				$n++;
				$wrapCode .= '<div id="g2g'.$n.'"></div>';
			} 
			$wrapCode .= '</div>';
			$wrapCode .= '<div style="clear:both; height:10px; overflow:hidden;"></div>';
			break;
        case 'gage3':
			...
			foreach($numAr as $n => $b){ 
				$n++; 
				$cssVar .= (count($numAr) == $n) ? '#g3g'.$n : '#g3g'.$n.', ';  
			}
			$wrapCode .= $cssVar.'{ width:200px; height:160px; display: inline-block; margin: 1em; }
				#gage3_chart{text-align:'.$align.';}';
			$wrapCode .= '</style>';
			$wrapCode .= '<script>';
			$sbIds = '';
			foreach($numAr as $n => $b){ 
			...
			$wrapCode .= 'var '.$sbIds.';'."\n";
			$wrapCode .= 'function anup3(){';
				foreach($numAr as $n => $v){ 
					$n++; 
					$wrapCode .= 'var g3g'.$n.' = new JustGage({
						  id: "g3g'.$n.'", 
						  value: '.$v[0].',
						  title: "'.$v[1].'",
						  valueFontColor: "'.$v[2].'",
			...
			$wrapCode .= 'jQuery(document).ready( function(){
				if ( jQuery("#gage3_chart").next().is(":appeared") ){
					if (  ! jQuery("#gage3_chart").hasClass("gc_active") ) {
						anup3();
						jQuery("#gage3_chart").addClass("gc_active");
					}
				} else {
					jQuery( window ).scroll(function() {
						if ( jQuery("#gage3_chart").next().is(":appeared") ){
			...
			$wrapCode .= '<div id="gage3_chart">';
			foreach($numAr as $n => $b){ 
				$n++;
				$wrapCode .= '<div id="g3g'.$n.'"></div>';
			} 
			$wrapCode .= '</div>';
			$wrapCode .= '<div style="clear:both; height:10px; overflow:hidden;"></div>';
			break;
        case 'gage4':
			...
			foreach($numAr as $n => $b){ 
				$n++; 
				$cssVar .= (count($numAr) == $n) ? '#g4g'.$n : '#g4g'.$n.', ';  
			}
			$wrapCode .= $cssVar.'{ width:200px; height:160px; display: inline-block; margin: 1em; }
				#gage4_chart{text-align:'.$align.';}';
			$wrapCode .= '</style>';
			$wrapCode .= '<script>';
			$sbIds = '';
			foreach($numAr as $n => $b){ 
				$n++; 
				$sbIds .= (count($numAr) == $n) ? 'g4g'.$n : 'g4g'.$n.', ';  
			}
			$wrapCode .= 'var '.$sbIds.';'."\n";
			$wrapCode .= 'function anup4(){';
				foreach($numAr as $n => $v){ 
					$n++; 
					$wrapCode .= 'var g4g'.$n.' = new JustGage({
						  id: "g4g'.$n.'", 
						  value: '.$v[0].',
						  title: "'.$v[1].'",
						  valueFontColor: "'.$v[2].'",
			...
			$wrapCode .= 'jQuery(document).ready( function(){
				if ( jQuery("#gage4_chart").next().is(":appeared") ){
					if (  ! jQuery("#gage4_chart").hasClass("gc_active") ) {
						anup4();
						jQuery("#gage4_chart").addClass("gc_active");
					}
				} else {
					jQuery( window ).scroll(function() {
						if ( jQuery("#gage4_chart").next().is(":appeared") ){
			...
			$wrapCode .= '<div id="gage4_chart">';
			foreach($numAr as $n => $b){ 
				$n++;
				$wrapCode .= '<div id="g4g'.$n.'"></div>';
			} 
			$wrapCode .= '</div>';
			$wrapCode .= '<div style="clear:both; height:10px; overflow:hidden;"></div>';
			break;
        case 'gage5':
			...
			foreach($numAr as $n => $b){ 
				$n++; 
				$cssVar .= (count($numAr) == $n) ? '#g5g'.$n : '#g5g'.$n.', ';  
			}
			$wrapCode .= $cssVar.'{ width:200px; height:160px; display: inline-block; margin: 1em; }
				#gage5_chart{text-align:'.$align.';}';
			$wrapCode .= '</style>';
			$wrapCode .= '<script>';
			$sbIds = '';
			foreach($numAr as $n => $b){ 
				$n++; 
				$sbIds .= (count($numAr) == $n) ? 'g5g'.$n : 'g5g'.$n.', ';  
			}
			$wrapCode .= 'var '.$sbIds.';'."\n";
			$wrapCode .= 'function anup5(){';
				foreach($numAr as $n => $v){ 
					$n++; 
					$wrapCode .= 'var g5g'.$n.' = new JustGage({
						  id: "g5g'.$n.'", 
						  value: '.$v[0].',
						  title: "'.$v[1].'",
						  valueFontColor: "'.$v[2].'",
			...
			$wrapCode .= 'jQuery(document).ready( function(){
				if ( jQuery("#gage5_chart").next().is(":appeared") ){
					if (  ! jQuery("#gage5_chart").hasClass("gc_active") ) {
						anup5();
						jQuery("#gage5_chart").addClass("gc_active");
					}
				} else {
					jQuery( window ).scroll(function() {
						if ( jQuery("#gage5_chart").next().is(":appeared") ){
			...
			$wrapCode .= '<div id="gage5_chart">';
			foreach($numAr as $n => $b){ 
				$n++;
				$wrapCode .= '<div id="g5g'.$n.'"></div>';
			} 
			$wrapCode .= '</div>';
			$wrapCode .= '<div style="clear:both; height:10px; overflow:hidden;"></div>';
			break;
        case 'gage6':
			...
			foreach($numAr as $n => $b){ 
				$n++; 
				$cssVar .= (count($numAr) == $n) ? '#g6g'.$n : '#g6g'.$n.', ';  
			}
			$wrapCode .= $cssVar.'{ width:200px; height:160px; display: inline-block; margin: 1em; }
				#gage6_chart{text-align:'.$align.';}';
			$wrapCode .= '</style>';
			$wrapCode .= '<script>';
			$sbIds = '';
			foreach($numAr as $n => $b){ 
				$n++; 
				$sbIds .= (count($numAr) == $n) ? 'g6g'.$n : 'g6g'.$n.', ';  
			}
			$wrapCode .= 'var '.$sbIds.';'."\n";
			$wrapCode .= 'function anup6(){';
				foreach($numAr as $n => $v){ 
					$n++; 
					$wrapCode .= 'var g6g'.$n.' = new JustGage({
						  id: "g6g'.$n.'", 
						  value: '.$v[0].',
						  title: "'.$v[1].'",
						  valueFontColor: "'.$v[2].'",
			...
			$wrapCode .= 'jQuery(document).ready( function(){
				if ( jQuery("#gage6_chart").next().is(":appeared") ){
					if (  ! jQuery("#gage6_chart").hasClass("gc_active") ) {
						anup6();
						jQuery("#gage6_chart").addClass("gc_active");
					}
				} else {
					jQuery( window ).scroll(function() {
						if ( jQuery("#gage6_chart").next().is(":appeared") ){
			...
			$wrapCode .= '<div id="gage6_chart">';
			foreach($numAr as $n => $b){ 
				$n++;
				$wrapCode .= '<div id="g6g'.$n.'"></div>';
			} 
			$wrapCode .= '</div>';
			$wrapCode .= '<div style="clear:both; height:10px; overflow:hidden;"></div>';
			break;
...
add_shortcode( 'skillwrapper1', 'skillwrapper_func' );
add_shortcode( 'skillwrapper2', 'skillwrapper_func' );
add_shortcode( 'skillwrapper3', 'skillwrapper_func' );
add_shortcode( 'skillwrapper4', 'skillwrapper_func' );
add_shortcode( 'skillwrapper5', 'skillwrapper_func' );
add_shortcode( 'skillwrapper6', 'skillwrapper_func' );
