...
function mk_sidenav_social_links(){
	...
	echo '<a href="/CV Alexis Prunier.pdf">French CV</a><br/>';
	echo '<a href="/CV Alexis Prunier - eng.pdf">English CV</a><br/>';
	echo "<br/>-<br/><br/>";
	
	if ( get_theme_mod( 'mk_sl_twitter' ) ){
	echo '<a href="'. esc_url( get_theme_mod( 'mk_sl_twitter' ) ).'" class="pixons-linkedin"></a>';
	}
...
//	echo '<a href="http://www.viadeo.com/profile/00225n0glhh9s2c" target="_blank"><img src="http://aprunier.com/wp-content/uploads/2015/09/ico_viadeo.png"/></a>';
echo '<a href="mailto:prunier.al@gmail.com"><img src="http://aprunier.com/wp-content/uploads/2017/11/Light-Mail-icon.png" style="width:20px;"/></a>';
